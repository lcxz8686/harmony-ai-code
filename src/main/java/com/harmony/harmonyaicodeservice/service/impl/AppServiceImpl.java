...
import com.harmony.harmonyaicodeservice.core.AiCodeGeneratorFacade;
import com.harmony.harmonyaicodeservice.core.builder.VueProjectBuilder;
import com.harmony.harmonyaicodeservice.core.handler.StreamHandlerExecutor;
...
import com.harmony.harmonyaicodeservice.model.dto.app.AppQueryRequest;
...
public class AppServiceImpl extends ServiceImpl<AppMapper, App> implements AppService {
    ...
    @Override
    public void validateAppOwner(Long appId, HttpServletRequest request) {
    ...
    public String deployApp(Long appId, User loginUser) {
        ...
        try {
            ...
            throw new BusinessException(ErrorCode.SYSTEM_ERROR, "部署应用失败，复制文件失败" + e.getMessage());
        }
        // 9. 更新数据库
